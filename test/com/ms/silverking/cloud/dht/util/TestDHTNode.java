...
public class TestDHTNode extends DHTNode {
  ...
  public TestDHTNode(String dhtName, ZooKeeperConfig zkConfig, DHTNodeConfiguration nodeConfig,
      ClientDHTConfiguration conf, int inactiveNodeTimeoutSeconds, ReapPolicy reapPolicy) {
    super(dhtName, zkConfig, nodeConfig, inactiveNodeTimeoutSeconds, reapPolicy, DHTConstants.noPortOverride, null);
