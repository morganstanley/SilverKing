...
import static com.ms.silverking.cloud.dht.client.crypto.TestUtil.checkName;
import static com.ms.silverking.cloud.dht.client.crypto.TestUtil.createXOR;
import static com.ms.silverking.cloud.dht.client.crypto.TestUtil.empty;
import static com.ms.silverking.cloud.dht.client.crypto.TestUtil.m2mAESCopy;
...
public class XOREncrypterDecrypterTest {
  ...
  private static final XOREncrypterDecrypter[][] testCasesEquals = { { negOneXOR, negOneXORCopy },
      { emptyXOR, emptyXOR }, { posOneXOR, posOneXOR }, { m2mXOR, m2mXORCopy }, };
  private static final EncrypterDecrypter[][] testCasesNotEquals = { { negOneXOR, emptyXOR }, { emptyXOR, posOneXOR },
      { posOneXOR, m2mXOR }, { m2mXOR, negOneXOR }, { m2mXOR, m2mAESCopy },    // xor vs aes
  };
