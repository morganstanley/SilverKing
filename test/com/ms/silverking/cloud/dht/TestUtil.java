...
public class TestUtil {
    ...
    public static final PutOptions poCopy               = new PutOptions(new OpSizeBasedTimeoutController(), null,            Compression.LZ4, ChecksumType.MURMUR3_32, false, 0, 0, PutOptions.noLock, DHTConstants.defaultFragmentationThreshold, null);
    public static final PutOptions poDiff               = new PutOptions(new WaitForTimeoutController(),     new HashSet<>(), Compression.LZ4, ChecksumType.MURMUR3_32, false, 0, 0, PutOptions.noLock, DHTConstants.defaultFragmentationThreshold, null);
    
    public static final InvalidationOptions ioCopy      = new InvalidationOptions(new OpSizeBasedTimeoutController(), null,            0, 0, PutOptions.noLock);
    public static final InvalidationOptions ioDiff      = new InvalidationOptions(new WaitForTimeoutController(),     new HashSet<>(), 0, 0, PutOptions.noLock);
