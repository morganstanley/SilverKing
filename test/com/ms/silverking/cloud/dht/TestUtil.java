...
public class TestUtil {
    ...
    public static final PutOptions poCopy          = new PutOptions(new OpSizeBasedTimeoutController(), null,            Compression.LZ4, ChecksumType.MURMUR3_32, false, 0, 0, 10_485_760, null);
    public static final PutOptions poDiff          = new PutOptions(new WaitForTimeoutController(),     new HashSet<>(), Compression.LZ4, ChecksumType.MURMUR3_32, false, 0, 0, 10_485_760, null);
    ...
    public static final WaitOptions woDiff         = new WaitOptions(new WaitForTimeoutController(), new HashSet<>(), RetrievalType.EXISTENCE, new VersionConstraint(Long.MIN_VALUE, Long.MAX_VALUE, Mode.GREATEST), NonExistenceResponse.NULL_VALUE, true, false, false, null, Integer.MAX_VALUE, 100, TimeoutResponse.EXCEPTION);
