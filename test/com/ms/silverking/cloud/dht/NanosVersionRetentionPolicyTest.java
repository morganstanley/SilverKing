...
public class NanosVersionRetentionPolicyTest {
  ...
  private static final NanosVersionRetentionPolicy defaultPolicyCopy = new NanosVersionRetentionPolicy(irisCopy,
      mrisCopy);
  private static final NanosVersionRetentionPolicy defaultPolicyAlmostCopy = new NanosVersionRetentionPolicy(irisCopy,
      mrisDiff);
  private static final NanosVersionRetentionPolicy defaultPolicyDiff = new NanosVersionRetentionPolicy(irisDiff,
      mrisDiff);
  ...
  public void testGetters() {
    ...
    // doesn't have other getters available.. getInvalidatedRetentionIntervalSeconds() or
    // getMaxRetentionIntervalSeconds()
  }
  ...
  public void testEqualsObject() {
    NanosVersionRetentionPolicy[][] testCases = { { defaultPolicy, defaultPolicy, defaultPolicyDiff },
  ...
  public void testToStringAndParse() {
    NanosVersionRetentionPolicy[] testCases = { defaultPolicy, defaultPolicyCopy, defaultPolicyAlmostCopy,
        defaultPolicyDiff, };
