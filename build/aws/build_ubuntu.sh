...
typeset output_filename=$(f_aws_getBuild_RunOutputFilename "ubuntu")
{
    ...
    echo ------------
    cat $BUILD_DIR/testing/junit/skfs-only/TEST-com.ms.silverking.fs.test.FileWriteWithDelayTest.xml
    echo ------------
    cat $BUILD_DIR/testing/junit/skfs-only/TEST-com.ms.silverking.fs.TruncateTest.xml
    echo ------------
    cat $BUILD_DIR/testing/junit/sk-only/TEST-com.ms.silverking.cloud.dht.client.example.MultiDHTExampleTest.xml
    echo ------------
