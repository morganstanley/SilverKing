#include "MultiPutMultiGetWaitTest.h"

#include "TestUtil.h"

TEST_F(MultiPutMultiGetWaitTest, PutGetHelloWorld) {
...
int main(int argc, char ** argv) {
	...
	putGetHelloWorld = new MultiPutMultiGetWait(o.gcName, o.host, o.ns, o.logfile, o.verbose, o.nsOptions, o.jvmOptions, o.compressType, o.valueVersion, o.retrievalType, o.key, o.value, 3, o.timeout, o.threshold);
