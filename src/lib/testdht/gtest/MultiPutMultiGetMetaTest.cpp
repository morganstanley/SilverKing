#include "MultiPutMultiGetMetaTest.h"

#include "TestUtil.h"

TEST_F(MultiPutMultiGetMetaTest, PutGetHelloWorld) {
...
int main(int argc, char ** argv) {
	...
	putGetHelloWorld = new MultiPutMultiGetMeta(o.gcName, o.host, o.ns, o.logfile, o.verbose, o.nsOptions, o.jvmOptions, o.compressType, o.valueVersion, o.retrievalType, o.key, o.value, 3);
