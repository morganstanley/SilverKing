...
#define DDW_DHT_QUEUE_PROCESSORS 3
#define DDW_DHT_THREADS_PER_QUEUE_PROCESSOR    2
#define DDW_DHT_QUEUE_SIZE    4096
#define DDW_MAX_BATCH_SIZE    100

#define DEF_LOG_GETATTR false
#define DEF_LOCK_ON_WRITE true
...
#define SKFS_LOCK_CLOCK_SKEW_TOLERANCE_MILLIS 10000
