...
public abstract class BaseWorker<I> {
   ...
   */
  public final void addPrioritizedWork(I item, int priority, int callerMaxDirectCallDepth, int idleThreadThreshold) {
    ...
    if (/*!ThreadState.isLWTThread()*/ false // FIXME think about this
        || threadPool.numIdleThreads() > idleThreadThreshold || ThreadState.getDepth() >= maxDirectCallDepth) {
      // Queue the work
