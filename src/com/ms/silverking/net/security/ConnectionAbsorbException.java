...
public class ConnectionAbsorbException extends Exception {
    ...
    public ConnectionAbsorbException(SocketChannel absorbedRawConn, ConnectionListener listenerForAbsorbedCon, boolean serverside, Throwable cause) {
        this(absorbedRawConn, absorbedRawConn.socket() != null ? absorbedRawConn.socket().toString() : "nullSock", listenerForAbsorbedCon, serverside, cause);
    }

    public ConnectionAbsorbException(SocketChannel absorbedRawConn, String absorbedConnStr, ConnectionListener listenerForAbsorbedCon, boolean serverside, Throwable cause) {
        super(cause);
    ...
    public String getAbsorbedInfoMessage() {
        ...
        return "Connection " + connInfo + " is absorbed in ["
