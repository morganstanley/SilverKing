...
public class JVMUtil {
  public static void dumpStackTraces() {
    ...
    for (ThreadInfo thread : threads) {
      ...
      System.out.println(
          "ThreadId:" + thread.getThreadId() + " " + "ThreadName:" + thread.getThreadName() + " " + "ThreadState:" + thread.getThreadState() + " " + "BlockedCount:" + thread.getBlockedCount() + " " + "WaitedCount: " + thread.getWaitedCount());
