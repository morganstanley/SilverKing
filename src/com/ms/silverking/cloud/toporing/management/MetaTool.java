...
public class MetaTool extends MetaToolBase {
    ...
    private static MetaToolModule getModule(Tool tool, MetaClient metaClient) throws KeeperException {
        switch (tool) {
        case Weights: return new WeightsZK(metaClient);
        //case Replication: return new ReplicationZK(metaClient);
        case RingConfiguration: return new RingConfigurationZK(metaClient);
        case StoragePolicyGroup: return new StoragePolicyGroupZK(metaClient);
    ...
    private static NamedRingConfiguration namedRingConfigurationFor(Tool tool, String name) {
        switch (tool) {
        case Weights: return new NamedRingConfiguration(null, 
                new RingConfiguration(CloudConfiguration.emptyTemplate, name, null, null, null, null, VersionedDefinition.NO_VERSION));
        //case Replication: return new NamedRingConfiguration(null, 
        //        new RingConfiguration(new CloudConfiguration(null, null), null, name, null, VersionedDefinition.NO_VERSION));
        case RingConfiguration: return new NamedRingConfiguration(name, 
                new RingConfiguration(CloudConfiguration.emptyTemplate, null, null, null, null, null, VersionedDefinition.NO_VERSION));
        case StoragePolicyGroup: return new NamedRingConfiguration(null, 
                new RingConfiguration(CloudConfiguration.emptyTemplate, null, null, name, null, null, VersionedDefinition.NO_VERSION));
        default: throw new RuntimeException("panic");
        }
    }
