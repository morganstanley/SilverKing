...
public class ZooKeeperExtended extends ZooKeeper
    implements AsyncCallback.StringCallback, AsyncCallback.VoidCallback, AsyncCallback.ChildrenCallback,
    AsyncCallback.DataCallback, AsyncCallback.StatCallback, AsyncCallback.Children2Callback {
  ...
  public static final String aclProviderSKDefProperty = ZooKeeperExtended.class.getPackage().getName() +
      ".AclProviderSKDef";
   ...
   * @throws IOException
   */
  public ZooKeeperExtended(ZooKeeperConfig zkConfig, int sessionTimeout, Watcher watcher)
  ...
  public StringCallbackOp createAsync(String path, byte[] data) throws KeeperException {
  ...
  public static ZooKeeperExtended getZooKeeperWithRetries(ZooKeeperConfig zkConfig, int sessionTimeout, Watcher watcher,
      int connectAttempts) throws KeeperException, IOException {
