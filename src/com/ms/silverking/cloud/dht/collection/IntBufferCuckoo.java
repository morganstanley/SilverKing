 ...
 * 
 */
public class IntBufferCuckoo extends CuckooBase implements Iterable<DHTKeyIntEntry> {
    ...
    class SubTable extends SubTableBase {
        ...
        private boolean entryMatches(long msl, long lsl, int bucketIndex, int entryIndex) {
            ...
            //        msl, lsl);
            return buf.get(baseOffset + mslOffset) == msl
                    && buf.get(baseOffset + lslOffset) == lsl;
        }
