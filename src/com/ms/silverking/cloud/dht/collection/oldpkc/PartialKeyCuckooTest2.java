...
public class PartialKeyCuckooTest2 {
    ...
    public static void main(String[] args) {
        try {
            ...
            map = new IntegerArrayPartialKeyCuckoo(new WritableCuckooConfig(totalEntries, numSubTables, entriesPerBucket, 128));
