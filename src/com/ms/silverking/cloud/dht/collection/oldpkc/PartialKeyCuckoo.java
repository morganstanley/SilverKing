...
public class PartialKeyCuckoo {
    ...
    private final SubTable    subTable0;
    private final SubTable    subTable1;
    private final SubTable    subTable2;
    private final SubTable    subTable3;
    
    private final ValueTable    valueTable;
        
    private static final int   vtIndexShift = 32;
    ...
    private PartialKeyCuckoo(int numSubTables, int entriesPerBucket, int totalEntries, int cuckooLimit, 
        ...
        subTable0 = this.subTables[0];
        subTable1 = this.subTables[1];
        subTable2 = this.subTables[2];
        subTable3 = this.subTables[3];
    }
    
    public PartialKeyCuckoo(int numSubTables, int entriesPerBucket, int totalEntries, int cuckooLimit) {
        this(numSubTables, entriesPerBucket, totalEntries, cuckooLimit, new SimpleValueTable(totalEntries), null);
    }
    
    public static PartialKeyCuckoo create(int totalEntries, int numSubTables, int entriesPerBucket, 
            ValueTable valueTable, long[][] subTableBufs) {
        return new PartialKeyCuckoo(numSubTables, entriesPerBucket, totalEntries, 0, valueTable, subTableBufs);
    }    
    ...
    public int getTotalSizeBytes() {
        return getPartialIndexSizeBytes() + valueTable.getSizeBytes();
    }
    
    public int getPartialIndexSizeBytes() {
    ...
    */
    ...
    class SubTable {
        ...
        private static final int   singleEntrySize = 1;
        ...
        SubTable(int numBuckets, int entriesPerBucket, int keyShift) {
            this(numBuckets, entriesPerBucket, keyShift, null);
        }
        ...
        private int getVTIndex(int baseOffset) {
            //System.out.println("getVTIndex baseOffset: "+ baseOffset +"\t"+ (int)(buf[baseOffset] >>> vtIndexShift));
        ...
        private void setPartialKeyAndVTIndex(int baseOffset, int partialKey, int vtIndex) {
            buf[baseOffset] = ((long)vtIndex << vtIndexShift) | ((long)partialKey & 0xffffffffL);
