...
public class StaticDHTCreator {
  ...
  public static void writeGridConfig(ClientDHTConfiguration clientConfig, String gridConfigDir, String gcName)
      throws IOException {
    writeGridConfig(clientConfig, new File(gridConfigDir), gcName);
  }

  public static void writeGridConfig(ClientDHTConfiguration clientConfig, File gridConfigDir, String gcName)
      throws IOException {
    // Write GridConfig
    Map<String, String> envMap;
  ...
  private static void writeGridConfig(SKGridConfiguration skGridConfig, File gridConfigDir, String gcName)
      throws IOException {
    File outputFile;
