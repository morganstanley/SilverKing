...
public class RingCurTargetTool {
	...
	public void go(SKGridConfiguration gc, RingCurTargetToolOptions options) throws IOException, KeeperException, CmdLineException {
		...
		case Write:
			...
			doWrite(zk, options.nodeType, getRingAndVersionPair(dhtConfig.getRingName(), options.versionPair)); break;
		case Read: doRead(zk, options.nodeType); break;
	...
	private void doWrite(DHTRingCurTargetZK zk, DHTRingCurTargetZK.NodeType nodeType, Triple<String,Long,Long> ringAndVersionPair) throws KeeperException {
