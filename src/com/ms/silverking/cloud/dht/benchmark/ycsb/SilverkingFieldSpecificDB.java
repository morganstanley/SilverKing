    ...
    try {
      ...
      if (session == null) {
        throw new RuntimeException("null session");
            ...
            nspOptions = nspOptions.defaultPutOptions(nspOptions.getDefaultPutOptions().compression(Compression.NONE)
            .checksumType(ChecksumType.NONE));
            System.out.println(nspOptions);
            */
      //syncNSP = session.openSyncNamespacePerspective(SilverkingDBConstants.namespace, SilverkingDBConstants
      // .nspOptions);
