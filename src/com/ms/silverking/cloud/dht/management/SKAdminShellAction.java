...
enum SKAdminShellAction {
  Mode, SyncData("sd", false), Target, Display, Help(false), Quit, ToggleVerbose("v", false), WaitForConvergence("w",
      false), TestTarget("tt", false), RecoverData("rd", false), RequestChecksumTree("rct", false);
