...
public class SKAdminShell implements Watcher {
  ...
  public SKAdminShell(SKGridConfiguration gc, InputStream in, PrintStream out, PrintStream err, String server, int port)
    ...
    this.out = out;
    this.err = err;
    rmc = (RingMasterControl) Naming.lookup(
        "rmi://" + server + ":" + port + "/" + RingMasterControl.getRegistryName(gc));
  ...
  private void doTarget(String[] args) throws RemoteException {
    if (args.length != 1) {
      ...
      target = Triple.parseDefault(ringDef, java.lang.String.class.getName(), java.lang.Long.class.getName(),
  ...
  private void doSyncData(String[] args) throws RemoteException {
    if (args.length != 2 && args.length != 3) {
      ...
      source = Triple.parseDefault(sourceRingDef, java.lang.String.class.getName(), java.lang.Long.class.getName(),
          java.lang.Long.class.getName());
      target = Triple.parseDefault(targetRingDef, java.lang.String.class.getName(), java.lang.Long.class.getName(),
          java.lang.Long.class.getName());
  ...
  private void doCommand(SKAdminShellAction action, String[] args)
      throws IOException, OperationException, KeeperException {
    ...
    case RecoverData:
      doRecoverData(args);
      break;
    case WaitForConvergence:
      doWaitForRequest(requestUUID(args));
      break;
    case RequestChecksumTree:
      doRequestChecksumTree(args);
      break;
    case Display:
      doDisplay(args);
      break;
