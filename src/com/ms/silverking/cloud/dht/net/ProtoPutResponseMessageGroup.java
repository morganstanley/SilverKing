...
public class ProtoPutResponseMessageGroup extends ProtoKeyedMessageGroup {
  ...
  public ProtoPutResponseMessageGroup(UUIDBase uuid, long context, long version, int numKeys, byte[] originator,
      byte storageState, int deadlineRelativeMillis) {
    super(MessageType.PUT_RESPONSE, uuid, context, ByteBuffer.allocate(optionsBufferSize), numKeys,
        keyBufferAdditionalBytesPerKey, originator, deadlineRelativeMillis, ForwardingMode.FORWARD);
