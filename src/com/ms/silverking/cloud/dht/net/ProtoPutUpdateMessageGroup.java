...
public class ProtoPutUpdateMessageGroup extends ProtoKeyedMessageGroup {
  ...
  public ProtoPutUpdateMessageGroup(UUIDBase uuid, long context, long version,
    ...
    super(MessageType.PUT_UPDATE, uuid, context, ByteBuffer.allocate(optionsBufferSize), destEntries.size(),
        keyBufferAdditionalBytesPerKey, originator, deadlineRelativeMillis, ForwardingMode.DO_NOT_FORWARD);
