...
public class ProtoChecksumTreeRequestMessageGroup extends ProtoMessageGroup {
    ...
    private static final int    dataBufferSize = 4 * NumConversion.BYTES_PER_LONG 
                                                 + 2 * ConvergencePoint.serializedSizeBytes + IPAndPort.SIZE_BYTES + 1;
    ...
    public ProtoChecksumTreeRequestMessageGroup(UUIDBase uuid, long context, 
                                                ...
                                                IPAndPort replica,
                                                boolean localFlag) {
        super(MessageType.CHECKSUM_TREE_REQUEST, uuid, context, originator, 
