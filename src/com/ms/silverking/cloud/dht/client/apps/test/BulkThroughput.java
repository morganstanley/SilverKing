...
public class BulkThroughput {
  ...
  public BulkThroughput(SKGridConfiguration gridConfig, PrintStream out, PrintStream err, BulkThroughputOptions options)
    ...
    try {
      ...
      _nsOptions = session.getDefaultNamespaceOptions().defaultPutOptions(
          session.getDefaultPutOptions().compression(options.compression).checksumType(options.checksumType));
  ...
  public void runParallelTest(BulkThroughputTest test, TestParameters p, int externalReps)
  ...
  public void runTest(BulkThroughputTest test, TestParameters p, int externalReps, int threadID,
      ...
      AsynchronousNamespacePerspective<String, byte[]> asyncNSP) throws PutException, RetrievalException {
  ...
  public void write(TestParameters p, List<Double> batchTimes, String context,
      SynchronousNamespacePerspective<String, byte[]> syncNSP) throws PutException {
    int k;
    int lastDisplay;
  ...
  public int read(TestParameters p, List<Double> batchTimes, String context,
      SynchronousNamespacePerspective<String, byte[]> syncNSP) throws RetrievalException {
    int k;
    int readSize;
    Stopwatch batchSW;
    int lastDisplay;
  ...
  public int readAsync(TestParameters p, String context, AsynchronousNamespacePerspective<String, byte[]> asyncNSP)
  ...
  public static void main(String[] args) {
    try {
      ...
      LWTPoolProvider.createDefaultWorkPools(
          DefaultWorkPoolParameters.defaultParameters().workUnit(options.clientWorkUnit));
      if (options.debug) {
        Log.setLevelAll();
      }
      System.out.printf("dedicatedNamespaces: %s\n", options.dedicatedNamespaces);
      bt = new BulkThroughput(SKGridConfiguration.parseFile(options.gridConfig), System.out, System.err, options);
