...
public class PerspectiveTest {
  ...
  public PerspectiveTest(SKGridConfiguration gridConfig, PrintStream out, PrintStream err)
  ...
  public static void main(String[] args) {
    try {
      if (args.length != 2) {
        ...
        pt = new PerspectiveTest(SKGridConfiguration.parseFile(gridConfig), System.out, System.err);
