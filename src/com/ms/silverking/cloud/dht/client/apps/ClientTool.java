...
public class ClientTool {
  ...
  private void doWaitFor(ClientOptions options, SynchronousNamespacePerspective<String, byte[]> syncNSP, Stopwatch sw)
  ...
  private void doMultiGet(ClientOptions options, SynchronousNamespacePerspective<String, byte[]> syncNSP, Stopwatch sw)
      throws OperationException, IOException {
  ...
  private void displayValueMap(Map<String, ? extends StoredValue<byte[]>> storedValues) {
    for (Map.Entry<String, ? extends StoredValue<byte[]>> entry : storedValues.entrySet()) {
      ...
      System.out.printf("%10s => %s\n", entry.getKey(),
          storedValue != null ? new String(storedValue.getValue()) : noSuchValue);
    }
  }

  private void doGet(ClientOptions options, SynchronousNamespacePerspective<String, byte[]> syncNSP, Stopwatch sw)
      throws OperationException, IOException {
    StoredValue<byte[]> storedValue;
  ...
  private void doGetValueAndMeta(ClientOptions options, SynchronousNamespacePerspective<String, byte[]> syncNSP,
      Stopwatch sw) throws OperationException, IOException {
    StoredValue<byte[]> storedValue;
  ...
  private StoredValue<byte[]> doRetrieve(ClientOptions options, SynchronousNamespacePerspective<String, byte[]> syncNSP,
      Stopwatch sw, RetrievalType retrievalType, WaitMode waitMode) throws OperationException, IOException {
  ...
  private Object _doRetrieve(ClientOptions options, SynchronousNamespacePerspective<String, byte[]> syncNSP,
      Stopwatch sw, RetrievalType retrievalType, WaitMode waitMode) throws OperationException, IOException {
    try {
      SynchronousNamespacePerspective<String, byte[]> ns;
  ...
  private void doPut(ClientOptions options, DHTSession session, SynchronousNamespacePerspective<String, byte[]> syncNSP,
      Stopwatch sw) throws OperationException, IOException {
    ...
    putOptions = session.getDefaultPutOptions().compression(
        options.compression != null ? options.compression : Compression.NONE).checksumType(
        options.checksumType).version(version);
  ...
  private void doMultiPut(ClientOptions options, DHTSession session,
      SynchronousNamespacePerspective<String, byte[]> syncNSP, Stopwatch sw) throws OperationException, IOException {
    PutOptions putOptions;
    long version;
    Map<String, byte[]> map;
  ...
  private void doSnapshot(ClientOptions options, SynchronousNamespacePerspective<String, byte[]> syncNSP, Stopwatch sw)
      throws OperationException, IOException {
    long version;
  ...
  private void doSyncRequest(ClientOptions options, SynchronousNamespacePerspective<String, byte[]> syncNSP,
      Stopwatch sw) throws OperationException, IOException {
    long version;
  ...
  private void doCreateNamespace(ClientOptions options, DHTSession session, Stopwatch sw)
      throws OperationException, IOException {
    long version;
  ...
  private void doGetNamespaceOptions(ClientOptions options, DHTSession session, Stopwatch sw)
      throws OperationException, IOException {
    long version;
    NamespaceOptions nsOptions;
  ...
  public void doAction(ClientOptions options) throws Exception {
    ...
    session = dhtClient.openSession(
        new SessionOptions(SKGridConfiguration.parseFile(options.gridConfig), options.server));
    if (session == null) {
