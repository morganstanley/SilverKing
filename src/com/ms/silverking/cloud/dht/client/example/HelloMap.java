...
public class HelloMap {
  ...
  public static Map<String, String> runExample(SKGridConfiguration gridConfig) {
    try {
      ...
      syncNSP = new DHTClient().openSession(gridConfig).openSyncNamespacePerspective("_POTUS", String.class,
          String.class);

      mapA = ImmutableMap.of("George Washington", "1789-1797", "John Adams", "1797-1801", "Thomas Jefferson",
          "1801-1809", "James Madison", "1809-1817", "James Monroe", "1817-1825");
      syncNSP.put(mapA);
