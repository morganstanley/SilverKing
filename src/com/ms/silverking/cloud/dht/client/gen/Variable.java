...
public class Variable implements Expression {
  ...
  private String _evaluate(Context c) {
    switch (type) {
    case Class:
      return c.getClass_().getSimpleName();
    case ClassHasEmptyConstructor:
    ...
    case LoopIndex:
      return Integer.toString(c.getLoopIndex());
    case LoopIndex_0Base:
      return Integer.toString(c.getLoopIndex() - 1);
    case LoopElements:
      return Integer.toString(c.getLoopElements());
    case MethodReturnTypeRaw:
      return getReturnTypeRaw(c.getMethod());
    case MethodReturnType:
      return getReturnType(c.getMethod(), false, null);
    case MethodReturnTypeSimple:
      return getReturnType(c.getMethod(), true, c.getEnclosingTypeSeparator());
    case MethodReturnTypeWrapper:
    ...
    case ConstructorSignature:
      return JNIUtil.getJNISignature(c.getConstructor());
    case ParameterName:
      return c.getParameter().getName();
    case ParameterNameWrapped:
      return getParameterNameWrapped(c.getParameter());
    case ParameterTypePackage:
      return getParameterTypePackage(c.getParameter());
    case ParameterType:
    ...
    case StaticFieldName:
      return c.getField().getName();
    case StaticFieldType:
      return getFieldType(c.getField(), false, null);
    case StaticFieldTypeSimple:
      return getFieldType(c.getField(), true, c.getEnclosingTypeSeparator());
    case StaticFieldTypeRaw:
      return getFieldTypeRaw(c.getField());
    case Enum:
    ...
    case InterfacePackage:
      return c.getInterface().getPackage().getName();
    case ReferencedClassSimple:
      return c.getReferencedClass().getSimpleName();
    case InheritedClass:
    ...
    case SuperClassPackage:
      return getSuperclassPackage(c.getClass_());
    case ImplementsInterfaces:
      return Boolean.toString(c.getClass_().getInterfaces().length > 0);
    case NonVirtual:
      return Boolean.toString(JNIUtil.nonVirtual(c.getClass_()));
    case JNICallType:
      return JNIUtil.getCallType(c.getMethod().getReturnType());
    case EmptyString:
      return "";
    default:
      throw new RuntimeException("Unknown variable: " + name);
