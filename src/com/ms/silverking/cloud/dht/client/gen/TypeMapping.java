...
public class TypeMapping {
  ...
  //private static Pattern        p = Pattern.compile("\\s*"+mapString+"\\(([\\w[.]]+),([\\w[.]]+)\\)\\s*\\{\\s*
  // ([^\\}]*)\\}\\s*([^\\}]*)\\}");
  private static Pattern p = Pattern.compile(
      "\\s*" + mapString + "\\(([\\w[.]]+),([\\w[.]]+)\\)\\s*\\{\\s*(.*;)\\s*(.*;)\\s*\\}");

  public TypeMapping(String javaType, String externalType, TypeMapCodeGenerator skToJavaGenerator,
