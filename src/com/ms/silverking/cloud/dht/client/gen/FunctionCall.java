...
public class FunctionCall implements Expression {
  ...
  public Pair<Context, String> evaluate(Context c) {
    ...
    switch (name) {
    case "Replace":
      return doReplace(c, resolvedArgs);
    case "SetOutputFile":
      return doSetOutputFile(c, resolvedArgs);
    case "SetEnclosingTypeSeparator":
      return doSetEnclosingTypeSeparator(c, resolvedArgs);
    case "Option":
      return doOption(c, resolvedArgs);
    case "Include":
      return doInclude(c, resolvedArgs);
    case "IfNotLastElement":
      return doIfNotLastElement(c, resolvedArgs);
