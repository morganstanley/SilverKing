...
public class ClientDHTConfiguration implements ClientDHTConfigurationProvider {
  ...
  public static final ClientDHTConfiguration embeddedKVS = new ClientDHTConfiguration(SessionOptions.EMBEDDED_KVS,
      new ZooKeeperConfig(new AddrAndPort[0]));
  ...
  public static final ClientDHTConfiguration emptyTemplate = new ClientDHTConfiguration("__dummy_name__", 1,
      "localhost:0");
