...
public class DHTNodeConfiguration {
    ...
    private static final String dataBasePathPropertyValue = PropertiesHelper.systemHelper.getString(dataBasePathProperty, UndefinedAction.ZeroOnUndefined);
    ...
    private void setDataBasePath(String __dataBasePath, InvalidPathAction invalidPathAction) {
        ...
        if (_dataBasePath != null) {
            ...
            case Warn:
                ...
                Log.warning("Either DHTNodeConfiguration.setDataBasePath() must be called later, or the candidates must be corrected");
                break;
            case ThrowException:
