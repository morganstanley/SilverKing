  ...
  public void update(DHTKey key, IPAndPort replica, RetrievalResult update, RetrievalVirtualCommunicator rvComm) {
    ...
    synchronized (entryState) {
      ...
      case CORRUPT:
        ...
        if (forwardingMode == ForwardingMode.DO_NOT_FORWARD) {
          ...
          case SECONDARY_FAILED:
            break;
          default:
            throw new RuntimeException("Unexpected prevState: " + prevState);
          }
        }
        break;
      ...
      case NO_SUCH_VALUE:
        ...
        if ((entryState.isPrimaryReplica(
            replica) && forwardingMode != ForwardingMode.ALL) || forwardingMode == ForwardingMode.DO_NOT_FORWARD) {
