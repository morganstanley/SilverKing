...
public class StorageParametersAndRequirements extends StorageParameters {
	...
	public StorageParametersAndRequirements(long version, int uncompressedSize, int compressedSize, short ccss,
			byte[] checksum, byte[] valueCreator, long creationTime, long requiredPreviousVersion) {
    ...
    public static StorageParametersAndRequirements fromSSStorageParametersAndRequirements(SSStorageParametersAndRequirements sp) {
    	if (sp instanceof StorageParameters) {
    		...
    		return new StorageParametersAndRequirements(sp.getVersion(), sp.getUncompressedSize(), sp.getCompressedSize(), 
					    			...
					    			sp.getChecksum(), sp.getValueCreator(), sp.getCreationTime(), sp.getRequiredPreviousVersion());
    	}
    }
        
    public static StorageParametersAndRequirements fromSSStorageParametersAndRequirements(SSStorageParametersAndRequirements sp, int uncompressedSize, 
