...
class SingleWriterConsistentStorageEntryState extends StorageEntryState {
    ...
    StateTransitionResult transitionFromState(IPAndPort replica, TwoPhaseStorageState prevState) {
        ...
        if (newState != prevState) {
            ...
            //Log.warning("Disallowed update: "+ state +"\t"+ newState);
    ...
    private StateTransitionResult updateState(IPAndPort replica, TwoPhaseStorageState prevState, TwoPhaseStorageState newState) {
        int replicaIndex;
