...
public class DHTRingMaster
  ...
  public DHTRingMaster(ZooKeeperConfig zkConfig, String dhtName, long intervalMillis, Mode mode, boolean enableLogging,
      ...
      if (currentRing == null) {
        ...
        if (!r.getV1().equals(currentRing.getV1())) {
          ...
          if (mode == Mode.Automatic) {
            ...
            if (debugValidTarget) {
              if (!versionsIncrease) {
                Log.warningAsyncf("Versions don't increase %s %s. Not allowed in Automatic mode.",
