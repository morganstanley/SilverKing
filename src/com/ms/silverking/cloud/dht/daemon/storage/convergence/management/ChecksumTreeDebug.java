...
public class ChecksumTreeDebug implements MessageGroupReceiver {
  ...
  public void debug(IPAndPort replica, long namespace, RingRegion region, ConvergencePoint sourceCP,
  ...
  public static void main(String[] args) {
    try {
      if (args.length < 8) {
        System.out.println(
            "args: <gridConfig> <sourceIP> <namespace> <dhtConfigVersion> <ringName> <sourceRing> <targetRing> " +
                "<ringRegion> [dataVersion]");
      } else {
