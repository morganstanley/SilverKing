...
public class NamespaceUtil {
  ...
  public static final GetOptions metaNSDefaultGetOptions = DHTConstants.standardGetOptions.forwardingMode(
  ...
  public static final PutOptions metaNSDefaultPutOptions = new PutOptions(DHTConstants.standardTimeoutController,
      DHTConstants.noSecondaryTargets, Compression.NONE, ChecksumType.MD5, false, PutOptions.defaultVersion,
      PutOptions.noVersionRequired, PutOptions.noLock, DHTConstants.defaultFragmentationThreshold, null);
  ...
  public static final NamespaceOptions metaInfoNamespaceOptions = OptionsHelper.newNamespaceOptions(StorageType.FILE,
      ConsistencyProtocol.TWO_PHASE_COMMIT, NamespaceVersionMode.SINGLE_VERSION, metaNSDefaultPutOptions,
      metaNSDefaultInvalidationOptions, metaNSDefaultGetOptions, DHTConstants.standardWaitOptions).asWriteOnce();
  ...
  public static final NamespaceProperties metaInfoNamespaceProperties = new NamespaceProperties(
      metaInfoNamespaceOptions);
  ...
  static {
    ...
    systemNamespaceProperties.put(
        ...
        new NamespaceProperties(DHTConstants.dynamicNamespaceOptions));
    systemNamespaceProperties.put(
        nsCreator.createNamespace(com.ms.silverking.cloud.dht.client.Namespace.replicasName).contextAsLong(),
        new NamespaceProperties(DHTConstants.dynamicNamespaceOptions));
  }
  ...
  public static boolean canMutateWith(NamespaceOptions oldOpts, NamespaceOptions newOpts) {
    ...
    return oldOpts.getStorageType() == newOpts.getStorageType() && oldOpts.getConsistencyProtocol() == newOpts.getConsistencyProtocol() && oldOpts.getVersionMode() == newOpts.getVersionMode() && oldOpts.getRevisionMode() == newOpts.getRevisionMode() && oldOpts.getSegmentSize() == newOpts.getSegmentSize() && oldOpts.getMaxValueSize() == newOpts.getMaxValueSize() && oldOpts.getAllowLinks() == newOpts.getAllowLinks();
  }
