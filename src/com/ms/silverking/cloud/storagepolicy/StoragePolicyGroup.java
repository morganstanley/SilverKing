...
public class StoragePolicyGroup implements VersionedDefinition {
    ...
    public StoragePolicyGroup(String name, NodeClassAndName rootClassAndName, Map<String,StoragePolicy> policies, long version) {
        this.name = name;
    ...
    public static StoragePolicyGroup create(String name, NodeClassAndName rootClassAndName, List<StoragePolicy> policyList, long version) {
