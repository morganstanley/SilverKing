...
public class SubPolicyMember {
    ...
    public SubPolicyMember(int quantity, 
                           NodeClassAndStoragePolicyName classAndPolicyName, 
                           Set<String> boundIDs) {
    ...
    private Set<Node> getNodesUnbound(Node parent, RingTreeRecipe recipe) {
        ...
        if (filteredChildren.size() < quantity && quantity != ALL) {
            ...
            Log.warning("filteredChildren.size(): "+ filteredChildren.size() +"\tquantity: "+ quantity);
            Log.warning("recipe: ", recipe);
