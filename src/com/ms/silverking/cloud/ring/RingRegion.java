    ...
    */
    ...
    public List<RingRegion> divide(List<Double> weights) {
        ...
        for (int i = 0; i < numRegions; i++) {
            ...
            //subRegionSize = (long)((double)getSize() * normalizedWeights.get(i));
            subRegionSize = new BigDecimal(getSize(), LongRingspace.mathContext).multiply(normalizedWeights.get(i), LongRingspace.mathContext).longValue();
            if (i < numRegions - 1) {
                subRegionEnd = subRegionStart + (subRegionSize - 1);
            } else {
                subRegionEnd = end;
    ...
    public static IntersectionResult intersect(RingRegion a, RingRegion b) {
        ...
        return new IntersectionResult(intersectionType, 
                       aNonOverlapping, bNonOverlapping, overlapping);
    }
    ...
    public static void testIntersection() {
        ...
        System.out.println();
        System.out.println();
        testIntersection(new RingRegion(4459345355264627536L,4470841357153488195L), new RingRegion(4469529232424279716L,4469544142932566175L));
    }
