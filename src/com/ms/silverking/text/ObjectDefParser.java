...
public class ObjectDefParser<T> {
  ...
  private static void checkFields(Object o, Set<String> fields, String setName) {
    for (String field : fields) {
      try {
        ...
        throw new RuntimeException(setName + " contained unknown field: " + field + " in " + o.getClass().getName());
      }
    }
  }

  public static void addTemplateAndOptionsAndExcluded(Object o, Set<String> optionalFields,
    ...
    templateMap.put(o.getClass(), new TemplateAndOptions(o, optionalFields, excludedFields));
  }
  ...
  private ObjectDefParser(T template, FieldsRequirement fieldsRequirement,
  ...
  public ObjectDefParser(T template, FieldsRequirement fieldsRequirement, Set<String> optionalFields,
    ...
    this(template, fieldsRequirement, NonFatalExceptionResponse.THROW_EXCEPTIONS,
        //NonFatalExceptionResponse.IGNORE_EXCEPTIONS,
        Character.toString(defaultFieldDefDelimiter), Character.toString(defaultNameValueDelimiter), optionalFields,
        exclusionFields);
  }
