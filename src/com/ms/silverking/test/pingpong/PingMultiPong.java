...
public class PingMultiPong {
  ...
  public void clientIteration(String pingKey, String pongKeyBase, long version)
    ...
    syncNSP.retrieve(pongKeys,
        syncNSP.getOptions().getDefaultWaitOptions().versionConstraint(VersionConstraint.exactMatch(version)));
    if (verbose) {
