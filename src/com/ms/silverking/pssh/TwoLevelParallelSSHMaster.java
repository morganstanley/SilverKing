...
public class TwoLevelParallelSSHMaster extends UnicastRemoteObject implements SSHMaster {
  ...
  public TwoLevelParallelSSHMaster(List<HostAndCommand> hostCommands, List<String> workerCandidateHosts,
    ...
    workerCommand[0] =
        javaCmd + " -cp " + classpath + " com.ms.silverking.pssh.TwoLevelParallelSSHWorker rmi://" + InetAddress.getLocalHost().getCanonicalHostName() + ":" + registryPort + "/SSHMaster " + numWorkerThreads + " " + timeoutSeconds;
    System.out.println(workerCommand[0]);

    System.out.println("\n\nMaster URL: " + url + "\n\n");
  }

  public TwoLevelParallelSSHMaster(Map<String, String[]> hostCommandsMap, List<String> workerCandidateHosts,
      int numWorkerThreads, int timeoutSeconds, int maxAttempts, boolean terminateUponCompletion) throws IOException {
  ...
  private void logState() {
    Log.warning(
        "Complete: " + completeHostCommands.size() + "\tIncomplete: " + incompleteHostCommands.size() + "\tActive: " + activeHostCommands.size() + "\tPending: " + pendingHostCommands.size());
  }
  ...
  public static void main(String[] args) {
    try {
      ...
      parallelSSH = new TwoLevelParallelSSHMaster(hostCommands, workerCandidateHosts, options.numWorkerThreads,
