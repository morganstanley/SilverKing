...
public class TwoLevelParallelSSHWorker implements Runnable {
  ...
  public TwoLevelParallelSSHWorker(String masterURL, int numWorkerThreads, int timeoutSeconds) throws Exception {
  ...
  public void run() {
    try {
      ...
      System.out.println("WorkerThread complete " + myHost);
      System.out.flush();
      ...
      if (running == 0) {
        try {
          ...
          System.out.println("Worker complete " + myHost + " " + new Date());
          System.out.flush();
